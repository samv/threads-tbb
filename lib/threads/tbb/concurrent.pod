...
Passing through blessed pointers / XS objects should be considered
dangerous; you'll usually be looking at the same C struct in both
threads.  You should consider whether or not this is a good idea for
you.  If in doubt, C<Storable::dclone> on the way in.
