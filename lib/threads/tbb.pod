...
C<$object> on sub-divided ranges; C<$object> will be cloned once for
each worker, as:

  $object->method( $range );

You should refrain from modifying anything accessible from C<$self>
within "method" without going through a L<threads::tbb::concurrent>
