...
These methods are available on I<body objects> which must first be
obtained by methods on the C<threads::tbb> object.
...
Creating both pipelines and filters is a method of the C<threads::tbb>
class:
